export const config = {
	mapTitle: 'map-pessimistic-europe', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-pessimistic-europe.vercel.app', // The url provided when deploying the map on Vercel
